...
const matrizColores = [{ valor: 0.05, color: "#c8ff54" }, { valor: 0.09, color: "#c8ff54" }, { valor: 0.07, color: "#c8ff54" }, { valor: 0.18, color: "#fffa23" },
    { valor: 0.36, color: "#ff2c1b" }, { valor: 0.72, color: "#ff2c1b" }, { valor: 0.03, color: "#00ff00" }, { valor: 0.14, color: "#fffa23" }, { valor: 0.28, color: "#f8a022" }, { valor: 0.56, color: "#ff2c1b" }, , { valor: 0.10, color: "#fffa23" }, { valor: 0.20, color: "#f8a022" }, { valor: 0.40, color: "#ff2c1b" }, { valor: 0.01, color: "#00ff00" }, { valor: 0.06, color: "#c8ff54" }, { valor: 0.06, color: "#c8ff54" },
...
document.getElementById('tdAmenazas').appendChild(table);
...
document.getElementById('tdOportunidades').appendChild(table2);
